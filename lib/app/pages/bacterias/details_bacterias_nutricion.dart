...
class BacteriaNutricionDetail extends StatelessWidget {
  final BacteriaNutricionInfo bacteriaInfo;

  const BacteriaNutricionDetail({Key key, this.bacteriaInfo}) : super(key: key);
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/img/tejidos/tejido_vegetal/tejido_vegetal_home.jpg"),
                  fit: BoxFit.cover,
                ),
              ),
              child: Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PrimaryText(
                        text: 'Bacterias Autotrofas', size: 26, fontWeight: FontWeight.w700),
                    SizedBox(
