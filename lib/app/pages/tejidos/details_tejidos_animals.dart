...
class TejidosAnimalsDetails extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return PageView.builder(
      itemCount: tejidosAnimalsList.length,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(tejidosAnimalsList[index].image),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PrimaryText(
                          text: tejidosAnimalsList[index].concept,
                          size: 17,
