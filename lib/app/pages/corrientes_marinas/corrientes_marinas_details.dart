...
class CorrientesMarinasDetails extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return PageView.builder(
      itemCount: corrientesMarinasList.length,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(corrientesMarinasList[index].image),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PrimaryText(
                          text: corrientesMarinasList[index].title,
                          size: 26,
                        ...
                        Container(
                          ...
                          child: PrimaryText(
                            text: corrientesMarinasList[index].concept,
                            size: 17,
